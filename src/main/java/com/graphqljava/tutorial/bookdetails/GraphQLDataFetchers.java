...
public class GraphQLDataFetchers {
    ...
    public DataFetcher getIsEditableDataFetcher() {
        return env -> {
            DataLoader<String, Boolean> isEditableDataLoader = env.getDataLoader("isEditable");
            Map<String, String> field = env.getSource();
            return isEditableDataLoader.load(field.get("id"));
        };
    }
}